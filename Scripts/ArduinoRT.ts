...
const kDefaultSamplesPerSec = 1000;
...
export class PhysicalDevice implements OpenPhysicalDevice {
   ...
   constructor(
      ...
      this.parser = new ParserWithSettings(deviceStream);
...
export class DeviceClass implements IDeviceClass {
   ...
   checkDeviceIsPresent(
      ...
      if (
         !(deviceConnection.vendorId === '2341' && deviceConnection.productId === '003E') //Due Native port 003E
         && !(deviceConnection.vendorId === '239A' && deviceConnection.productId === '801B') //ADAFruit Feather M0 Express
         && !(deviceConnection.vendorId === '239A' && deviceConnection.productId === '8022') //ADAFruit Feather M4 
         && !(deviceConnection.vendorId === '1B4F' && deviceConnection.productId === 'F016') //Sparkfun Thing Plus SAMD51 
         //deviceConnection.productId !== '003D' || Due Native port 003E
